...
# Lista con gioni della settimana nel mese di ottobre 2025
ottobre = week[2:]+week*3+week[:5]

print(ottobre)


# Dizionario ottobre 2025 per giorno del mese e della settimana (metodo base)
dict_ottobre = {}
...
# Dizionario ottobre 2025 per giorno del mese e della settimana (metodo con list comprehension)
